...
'''
This module provides a class for communicating with the GW Instek AFG-2225.
It is taken from nEXO's scripts and may need to be modified for the Decay Sail project.
'''
